...
import { PostCard } from '../components/feed/PostCard'; // Memanggil kartu estetik kita
...
export const Profile = () => {
  ...
  // State untuk menyimpan postingan milik sendiri
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Ambil postingan khusus milik user ini (?mine=true)
  ...
  // Fungsi like agar profil juga interaktif
        ...
        {isLoading ? (
          ...
          myPosts.length === 0 ? (
            ...
            myPosts.map((post, index) => {
              ...
              return (
                <div key={post.id} className="animate-card" style={{ animationDelay: `${index * 0.05}s` }}>
                  <PostCard 
                    id={post.id}
